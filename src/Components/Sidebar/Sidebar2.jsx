...
const Sidebar = () => {
  ...
  return (
    <div className=" border-2 sticky z-10 top-24 border-gray-300 rounded-2xl p-6 mt-3 max-2xl:h-[25%]   h-[23%] bg-white w-[80%] shadow-lg hover:shadow-xl transition-shadow duration-300">
