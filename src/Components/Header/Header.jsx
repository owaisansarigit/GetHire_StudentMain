      ...
      <div className="bg-[#fff] h-[70px] w-full flex justify-start items-center p-[10px] pl-20 shadow-md ">
          ...
          <div className=" hidden text-[18px] justify-center items-center font-[400] md:flex gap-[38px] max-2xl:gap-[33px] max-xl:gap[30px]  font-[Outfit] ">
            {/* <Link to="/" className="hover:text-blue-700">Home</Link> */}
               ...
               <div className="flex items-center p-1 font-medium text-lg h-10  text-blue-500 hover:cursor-pointer hover:text-blue-700 "
                 onMouseEnter={()=>{setOpportunities(true)}} onMouseLeave={()=>{setOpportunities(false)}}>
                 Opportunities
               </div>
              ...
              <div
                ...
                onMouseEnter={() => {setMode(true);setOpportunities(false);}}
            ...
            {/* search baar */}
              ...
              {/* Ai tool section */}
            <div className="border flex justify-center max-xl:text-[10px] hover:bg-blue-700 hover:text-white duration-300 items-center  rounded-2xl text-sm py-1 px-2 font-semibold text-blue-500 cursor-pointer"
                onClick={() => setAiModal(true)}
              >
                 <img src="https://www.gstatic.com/lamda/images/gemini_sparkle_v002_d4735304ff6292a690345.svg" alt="ai logo" 
                   className=" h-5" 
                />
