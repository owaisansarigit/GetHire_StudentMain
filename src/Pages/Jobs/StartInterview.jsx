...
//   return (
//     <div className="w-full h-full bg-white font-[poppins]">
...
//                   <div className="w-1/2 border rounded-2xl min-h-[60vh]">
//                     <video
//                       className="w-full h-full object-cover"
...
//                       Minimise clutter :{" "}
//                       <span className="text-gray-500 text-sm">
//                         Keep your bacground professional and free from
//                         distractions using a plain or blurred background
//                       </span>
//                     </div>
//                     <div className="text-yellow-500 text-sm font-[400]">
//                       frame yourself correctly :{" "}
//                       <span className="text-gray-500 text-sm">
//                         center your self in the frame with your head and
//                         shoulder visible
//                       </span>
//                     </div>
//                     <div className="text-yellow-500 text-sm font-[400]">
