...
const Portfolio = () => {
  ...
  const [positionOfResponsibilityModal, setPositionOfResponsibilityModal] = useState(false);
  ...
  const [academicAndPersonalProjectModal, setAcademicAndPersonalProjectModal] = useState(false);
          ...
          <div className="font-[Outfit] p-[20px] lg:pt-[89px] lg:px-[105px] flex flex-col justify-center items-center">
            ...
            <div className="flex p-[21px] border-[2px] w-full border-[#8feafe] rounded-[3px] mt-[27px] items-center gap-[18px]">
              ...
              <p className="text-[16px] font-[400] text-[#4234a2] text-opacity-[50%]">
                This is the resume that the employer will see: Please complete your
                resume to increase your chances of hining
              </p>
            </div>
            <div className="bg-white rounded-[12px] w-full p-[10px] lg:py-[50px] lg:px-[76px] mt-[33px]">
              <div className="flex flex-col gap-[20px] lg:flex-row justify-between border-b-[1px] border-[#ebe6e6] pb-[29px]">
                <div>
                  <div className="flex items-center gap-[9px]">
                    <p className="text-[32px] font-[400]">{studentprofile?.Name}</p>
              ...
              <div className="flex flex-col lg:flex-row py-[25px] border-b-[1px] gap-[10px] lg:gap-[87px] border-[#ebe6e6]">
                ...
                >
                  <img
                    ...
                    alt=""
                  />
                  <p className="text-[16px] font-[500] text-[#4234a2]">Add Video</p>
                </div>
              </div>
              <div className="flex flex-col lg:flex-row gap-[10px] lg:gap-[162px] pt-[14px] pb-[30px] border-b-[1px] border-[#ebe6e6]">
                ...
                <div className="w-full">
                  ...
                  <div onClick={toggleAddEducationModalOpen} className="flex gap-[3px] items-center mt-[18px] cursor-pointer">
                    <img
                      src="/images/mingcute_add-fill.svg"
                      className="w-[14px] h-[14px]"
                      alt=""
                  ...
                  <div className="w-full">
                    {studentprofile?.JobDetails?.map((Job, index) => (
                      <div key={index} className="mb-5">
                        ...
                        <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">
                          Join Date -  {formatDate(Job?.Start_date)}  {Job?.Currentlyworking ? "- Currently Working" : "End date " - formatDate(Job?.End_date)}
                        </p>
                        <div className="flex">
                          <p className="text-[16px] font-[400]" >Describtion - </p><p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Job?.Description}</p>
                        </div>
                      </div>
                    ))}
                    <div className="flex justify-between items-center mt-5">
                      ...
                      >
                        <img
                          ...
                          alt=""
                        />
                        <p className="text-[16px] font-[500] text-[#4234a2]">Add job</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full">
                    {studentprofile?.Training_details?.map((Training, index) => (
                      <div key={index} className="mb-5">
                        ...
                        <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">
                          Join Date -  {formatDate(Training?.Start_date)}  {Training?.CurrentlyOngoing ? "Currently Ongoing" : "End Date - " + formatDate(Training?.End_date)}
                        </p>
                        <div className="flex">
                          <p className="text-[16px] font-[400]" >Describtion - </p><p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Training?.Description}</p>
                        </div>
                      </div>
                    ))}
                    <div className="flex justify-between items-center mt-5">
                  ...
                  <div className="w-full">
                    {studentprofile?.Projects?.map((Project, index) => (
                      <div key={index} className="mb-5">
                        ...
                        <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">
                          Join Date -  {formatDate(Project?.Start_date)}  {Project?.CurrentlyOngoing ? "Currently Ongoing" : "End Date - " + formatDate(Project?.End_date)}
                        </p>
                        <div className="flex">
                          <p className="text-[16px] font-[400]" >Describtion - </p><p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Project?.Description}</p>
                        </div>
                        <div>
                  ...
                  <div className=" w-full">
                    {studentprofile?.Work_Samples?.map((Samples, index) => (
                      <div key={index} className="mb-5">
                        ...
                        <div className="flex">
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]" >
                            Play store developer public link - </p>
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Samples?.Playstoredeveloperpubliclink}
                          </p>
                        </div>
                        <div className="flex">
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]" >
                            Behance portfolio link - </p>
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Samples?.Behance_portfolio_link}
                          </p>
                        </div>
                        <div className="flex">
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]" >
                            Other work sample link - </p>
                          <p className="text-[16px] font-[400] text-[#000] text-opacity-[50%]">{Samples?.Other_work_sample_link}
                          </p>
                        </div>
                      </div>
                    ))}
                    <div onClick={toggleWorkSampleModalOpen} className="flex gap-[3px] items-center cursor-pointer">
                      <img
                        src="/images/mingcute_add-fill.svg"
                        className="w-[14px] h-[14px]"
                        alt=""
              ...
              <div className="flex flex-col lg:flex-row py-[25px] border-b-[1px] gap-[10px] lg:gap-[88px] border-[#ebe6e6]">
                ...
                <div className="flex gap-[30px]">
                  <div className="w-full">
                    ...
                    <div onClick={toggleAdditionalDetailsModalOpen} className="flex gap-[3px] items-center mt-4 cursor-pointer">
                      <img
                        src="/images/mingcute_add-fill.svg"
                        className="w-[14px] h-[14px] "
                        alt=""
